    ...
    public void init() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (animatedValue<64) {
                    colorStart = Color.rgb(135, 206-animatedValue, 250);
                    ...
                    animator1.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public void onAnimationUpdate(ValueAnimator animation) {
                            ...
                            colorStart = Color.rgb(135-animatedValue1,143-animatedValue1, 250);
                            ...
                            if (animatedValue1==90){
                                ...
                                animator2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                                    ...
                                    public void onAnimationUpdate(ValueAnimator animation) {
                                        ...
                                        colorStart = Color.rgb(45,53+animatedValue2,255);
                                        colorEnd = Color.rgb(184,118+animatedValue2,255);
                                        invalidate();
                                    }
                                });
                                animator2.start();
