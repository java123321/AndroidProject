...
public class NumPicker_title {
    ...
    NumPicker_title(Activity activity) {
        mActivity = activity;
        initDialog();
    ...
    private void initDialog() {
        ...
        mDialog.setContentView(mActivity.getLayoutInflater().inflate(R.layout.wheel_title, null));
        ...
        mNpv = mDialog.findViewById(R.id.title);
        setListener();
    }
